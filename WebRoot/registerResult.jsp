...
if(document.all){
    ...
    <title>欢迎光临 Happy BookShop</title>
  ...
  <table width="80%" border="0" bgcolor="#B0E5FF" align="center">
       ...
       <tr><td><h4 align="center">
        ...
        <hr size="1" color="#C5a5a7" width="80%">
         &nbsp; &nbsp; <p> &nbsp; &nbsp; <p> &nbsp; &nbsp; <p>
         <center><font color="red" size="+4" face="隶书"> Happy  BookShop 注册</font> </center>
         <%
         	int result=(Integer)session.getAttribute("registerResult");
         %>
         <%
         	if(result > 0) {
         		response.setHeader("Refresh", "5;URL=index.jsp");
         %>
         		<center><font color="red" size="+3" face="隶书">注册成功</font> </center>
         		<center><a href="index.jsp">浏览器将在5秒后自动跳转到主页，点击此处立即返回</a></center>
         <%
         	} else {
         		response.setHeader("Refresh", "30;URL=index.jsp");
         %>
         		<center><font color="red" size="+3" face="隶书">注册失败</font> </center>
         		<center><a href="index.jsp">浏览器将在30秒后自动跳转到主页，点击此处立即返回</a></center>
         <%
         	}
         %>
